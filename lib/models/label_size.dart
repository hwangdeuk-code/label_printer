...
class LabelSizeDAO extends DAO {
  ...
  static const String SelectSql = '''
    SELECT
        ...
        RICH_LABELSIZE_ID,
        RICH_BRAND_ID,
        CONVERT(NVARCHAR(50),RICH_LABELSIZE_NAME COLLATE ${DAO.CP949}),
        RICH_FORM_WIDTH,
        RICH_FORM_HEIGHT,
        CONVERT(NVARCHAR(MAX),RICH_FORM_DATA COLLATE ${DAO.CP949}),
        RICH_SETUP_READONLY,
        RICH_SETUP_USE_MAKEDATE,
        RICH_SETUP_USE_MAKETIME,
        RICH_SETUP_USE_VALIDDATE,
        RICH_SETUP_USE_VALIDTIME,
        RICH_SETUP_MAKEDATE_TYPE,
        RICH_SETUP_MAKETIME_TYPE,
        RICH_SETUP_VALIDDATE_TYPE,
        RICH_SETUP_VALIDTIME_TYPE,
        CONVERT(NVARCHAR(50),RICH_USER_MAKEDATE COLLATE ${DAO.CP949}),
        CONVERT(NVARCHAR(50),RICH_USER_MAKETIME COLLATE ${DAO.CP949}),
        CONVERT(NVARCHAR(50),RICH_USER_VALIDDATE COLLATE ${DAO.CP949}),
        CONVERT(NVARCHAR(50),RICH_USER_VALIDTIME COLLATE ${DAO.CP949}),
        RICH_SETUP_USE_SCALE
			)) AS ${DAO.LINE_U16LE}
